...
func main0() struct{} {
    ...
    var result__12 int32 = impl_inherent_closure_env_f1_3_apply(f1__11, 1)
    var t4 string = int32_to_string(result__12)
    ret11 = string_println(t4)
    return ret11
}

func impl_inherent_closure_env_f4_0_apply(env0 closure_env_f4_0, w__7 int32) int32 {
    var ret12 int32
...
func impl_inherent_closure_env_f3_1_apply(env1 closure_env_f3_1, z__5 int32) int32 {
    var ret13 int32
    ...
    ret13 = impl_inherent_closure_env_f4_0_apply(f4__8, 4)
    return ret13
}

func impl_inherent_closure_env_f2_2_apply(env2 closure_env_f2_2, y__3 int32) int32 {
    var ret14 int32
    ...
    ret14 = impl_inherent_closure_env_f3_1_apply(f3__9, 3)
    return ret14
}

func impl_inherent_closure_env_f1_3_apply(env3 closure_env_f1_3, x__1 int32) int32 {
    var ret15 int32
    ...
    ret15 = impl_inherent_closure_env_f2_2_apply(f2__10, 2)
    return ret15
}
