...
func closure_early(x__1 int32) int32 {
    ...
    var t27 int32 = _goml_m_inherent_i_closure__env__f__0_i_closure__env__f__0_i_apply(f__3, x__1)
    retv26 = t27
    return retv26
}
...
func _goml_m_inherent_i_closure__env__f__0_i_closure__env__f__0_i_apply(env17 closure_env_f_0, y__2 int32) int32 {
    var retv45 int32
    var t48 bool = y__2 > 5
    if t48 {
        retv45 = y__2
