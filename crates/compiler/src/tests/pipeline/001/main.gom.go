...
func main0() struct{} {
    ...
    var x25 Tuple2_4bool_4bool = a__0._2
    var x27 bool = x25._1
    var w__4 bool = x27
    var b__5 bool = w__4
    print__T_bool(b__5)
...
func print__T_bool(value__0 bool) struct{} {
    var t32 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(value__0)
    _goml_runtime_core_string_print(t32)
    return struct{}{}
}

func _goml_m_trait__impl_i_ToString_i_bool_i_to__string(self__8 bool) string {
    var retv35 string
    var t36 string = _goml_runtime_core_bool_to_string(self__8)
    retv35 = t36
    return retv35
}
