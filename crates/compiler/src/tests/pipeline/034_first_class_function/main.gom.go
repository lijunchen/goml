...
func compose(f__4 func(int32) int32, g__5 func(int32) int32, value__6 int32) int32 {
    var retv78 int32
    var t79 int32 = g__5(value__6)
    var t80 int32 = f__4(t79)
    retv78 = t80
    return retv78
}
...
func main0() struct{} {
    ...
    var t82 string = _goml_m_inherent_i_int32_i_int32_i_to__string(composed__9)
    printer__20(t82)
    var t83 string = _goml_m_inherent_i_int32_i_int32_i_to__string(closure_result__12)
    printer__20(t83)
    var t84 string = _goml_m_inherent_i_int32_i_int32_i_to__string(invoked_with_global__16)
    printer__20(t84)
    var t85 string = _goml_m_inherent_i_int32_i_int32_i_to__string(composed_by_closure__19)
    printer__20(t85)
    return struct{}{}
}
...
func _goml_m_inherent_i_closure__en_haa892b00b0eb7ffc029d576cdd67daaf_pply__0_i_apply(env65 closure_env_closure_apply_0, value__10 int32) int32 {
    var retv95 int32
    var t96 int32 = apply_once(increment, value__10)
    retv95 = t96
    return retv95
}

func _goml_m_inherent_i_closure__en_h3286eba341bf64dee5b16b571aed9928_oker__1_i_apply(env66 closure_env_global_invoker_1, func_to_call__13 func(int32) int32, value__14 int32) int32 {
    var retv98 int32
    var t99 int32 = apply_once(func_to_call__13, value__14)
    retv98 = t99
    return retv98
}

func _goml_m_inherent_i_closure__en_h55d634371047d8dd612a447303ccba2c_sure__2_i_apply(env67 closure_env_composer_closure_2, value__17 int32) int32 {
    var retv101 int32
    var t102 int32 = compose(double, increment, value__17)
    retv101 = t102
    return retv101
}
