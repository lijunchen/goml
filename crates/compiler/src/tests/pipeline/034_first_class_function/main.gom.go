...
func main0() struct{} {
    ...
    var t12 string = int32_to_string(composed__9)
    printer__20(t12)
    var t13 string = int32_to_string(closure_result__12)
    printer__20(t13)
    var t14 string = int32_to_string(invoked_with_global__16)
    printer__20(t14)
    var t15 string = int32_to_string(composed_by_closure__19)
    printer__20(t15)
    return struct{}{}
}
...
func _goml_inherent_closure_env_closure_apply_0_closure_env_closure_apply_0_apply(env4 closure_env_closure_apply_0, value__10 int32) int32 {
    var t16 int32 = apply_once(increment, value__10)
    return t16
}
...
func _goml_inherent_closure_env_global_invoker_1_closure_env_global_invoker_1_apply(env5 closure_env_global_invoker_1, func_to_call__13 func(int32) int32, value__14 int32) int32 {
    var t17 int32 = apply_once(func_to_call__13, value__14)
    return t17
}
...
func _goml_inherent_closure_env_composer_closure_2_closure_env_composer_closure_2_apply(env6 closure_env_composer_closure_2, value__17 int32) int32 {
    var t18 int32 = compose(double, increment, value__17)
    return t18
}
