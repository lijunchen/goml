...
func cut_pair(ok__0 bool) _goml_m_Option_____o_string_c_string_q_ {
    var retv7 _goml_m_Option_____o_string_c_string_q_
    var jp9 _goml_m_Option_____o_string_c_string_q_
    if ok__0 {
        var t10 Tuple2_6string_6string = Tuple2_6string_6string{
            _0: "left",
            _1: "right",
        }
        var t11 _goml_m_Option_____o_string_c_string_q_ = _goml_m_Option_____o_string_c_string_q__Some{
            _0: t10,
        }
        jp9 = t11
    } else {
        jp9 = _goml_m_Option_____o_string_c_string_q__None{}
    }
    retv7 = jp9
    return retv7
}
