...
func main0() struct{} {
    ...
    var first__7 int32 = impl_inherent_closure_env_next_0_apply(next__5)
    var second__8 int32 = impl_inherent_closure_env_next_0_apply(next__5)
    impl_inherent_closure_env_reset_1_apply(reset__6)
    var third__9 int32 = impl_inherent_closure_env_next_0_apply(next__5)
    ...
    var fourth__12 int32 = impl_inherent_closure_env_next_0_apply(new_next__11)
...
func impl_inherent_closure_env_next_0_apply(env13 closure_env_next_0) int32 {
    var ret22 int32
...
func impl_inherent_closure_env_reset_1_apply(env14 closure_env_reset_1) struct{} {
    var ret23 struct{}
