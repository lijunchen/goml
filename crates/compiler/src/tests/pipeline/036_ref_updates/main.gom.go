...
func bump(cell__0 *ref_int32_x) int32 {
    ...
    var t14 int32 = t13 + 1
    ref_set__Ref_5int32(cell__0, t14)
    var t15 int32 = ref_get__Ref_5int32(cell__0)
    retv12 = t15
    return retv12
}
...
func flip(flag__1 *ref_bool_x) bool {
    var retv17 bool
    var current__2 bool = ref_get__Ref_4bool(flag__1)
    var t18 bool = !current__2
    ref_set__Ref_4bool(flag__1, t18)
    var t19 bool = ref_get__Ref_4bool(flag__1)
    retv17 = t19
    return retv17
}
...
func nested_total(cell__3 *ref_Ref_5int32_x) int32 {
    var retv21 int32
    var inner__4 *ref_int32_x = ref_get__Ref_10Ref_5int32(cell__3)
    var before__5 int32 = ref_get__Ref_5int32(inner__4)
    var t22 int32 = before__5 + 2
    ref_set__Ref_5int32(inner__4, t22)
    var t23 int32 = ref_get__Ref_5int32(inner__4)
...
func alias_bump(cell__6 *ref_int32_x) int32 {
    ...
    var t27 int32 = ref_get__Ref_5int32(alias__7)
    var t28 int32 = t27 + 5
    ref_set__Ref_5int32(alias__7, t28)
    var t29 int32 = ref_get__Ref_5int32(alias__7)
    retv26 = t29
    return retv26
}
...
func pair_sum() int32 {
    var retv31 int32
    var first__8 *ref_int32_x = ref__Ref_5int32(4)
    var second__9 *ref_int32_x = ref__Ref_5int32(6)
    var t32 int32 = ref_get__Ref_5int32(first__8)
    var t33 int32 = ref_get__Ref_5int32(second__9)
    var t34 int32 = t32 + t33
    ref_set__Ref_5int32(first__8, t34)
    var t35 int32 = ref_get__Ref_5int32(first__8)
    var t36 int32 = ref_get__Ref_5int32(second__9)
...
func reassign_nested(nested__10 *ref_Ref_5int32_x) int32 {
    var retv39 int32
    var inner__11 *ref_int32_x = ref_get__Ref_10Ref_5int32(nested__10)
    var t40 int32 = ref_get__Ref_5int32(inner__11)
    var t41 int32 = t40 + 7
    ref_set__Ref_5int32(inner__11, t41)
    var t42 int32 = ref_get__Ref_5int32(inner__11)
    retv39 = t42
    return retv39
}

func main0() struct{} {
    var counter__12 *ref_int32_x = ref__Ref_5int32(39)
    var toggler__13 *ref_bool_x = ref__Ref_4bool(false)
    var t44 *ref_int32_x = ref__Ref_5int32(3)
    var nested__14 *ref_Ref_5int32_x = ref__Ref_10Ref_5int32(t44)
    var bumped__15 int32 = bump(counter__12)
    var flipped__16 bool = flip(toggler__13)
    var flipped_again__17 bool = flip(toggler__13)
    var inner__18 *ref_int32_x = ref_get__Ref_10Ref_5int32(nested__14)
    var t45 int32 = ref_get__Ref_5int32(inner__18)
    var t46 int32 = t45 + bumped__15
    ref_set__Ref_5int32(inner__18, t46)
