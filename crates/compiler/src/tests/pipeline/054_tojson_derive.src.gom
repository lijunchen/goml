...
func impl_inherent_Point_to_json(self__0 Point) string {
    var ret44 string
...
func impl_inherent_Person_to_json(self__3 Person) string {
    var ret45 string
...
func impl_inherent_Color_to_json(self__7 Color) string {
    var ret46 string
...
func main0() struct{} {
    ...
    var t40 string = impl_inherent_Point_to_json(p__11)
    string_println(t40)
    var t41 string = impl_inherent_Person_to_json(person__12)
    string_println(t41)
    var t42 string = impl_inherent_Color_to_json(c1__13)
    string_println(t42)
    var t43 string = impl_inherent_Color_to_json(c2__14)
    string_println(t43)
    ret47 = struct{}{}
    return ret47
}
