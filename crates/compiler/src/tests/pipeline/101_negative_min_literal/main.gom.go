...
func main0() struct{} {
    var a__0 int8 = -128
    var t10 string = _goml_m_trait__impl_i_ToString_i_int8_i_to__string(a__0)
    println__T_string(t10)
    var b__1 int16 = -32768
    var t11 string = _goml_m_trait__impl_i_ToString_i_int16_i_to__string(b__1)
...
func _goml_m_trait__impl_i_ToString_i_int8_i_to__string(self__11 int8) string {
    var retv16 string
    var t17 string = _goml_runtime_core_int8_to_string(self__11)
    retv16 = t17
    return retv16
}
