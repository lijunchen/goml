...
func main0() struct{} {
    ...
    for {
        ...
        if jp31 {
            var t32 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(total__1)
            var t33 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__0)
            var t34 int32 = t32 + t33
            _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(total__1, t34)
            ...
            if t39 {
                ...
                var t37 int32 = t36 + 1
                _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(i__0, t37)
                continue
            }
        } else {
            break Loop_loop29
    ...
    var t17 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(total__1)
    ...
    Loop_loop20:
    for {
        var mtmp7 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(j__2)
        var jp22 bool
        switch mtmp7 {
        case 0:
        ...
        if jp22 {
            ...
            var t24 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(j__2)
            var t25 int32 = t23 + t24
            _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(total2__3, t25)
            var t27 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(j__2)
            var t28 bool = t27 == 2
            if t28 {
                break Loop_loop20
            } else {
    ...
    var t19 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(total2__3)
