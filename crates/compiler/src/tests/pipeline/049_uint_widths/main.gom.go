...
func main0() struct{} {
    ...
    var t9 string = _goml_m_trait__impl_i_ToString_i_uint8_i_to__string(sum8__2)
    var t10 string = t9 + ", "
    var t11 string = _goml_m_trait__impl_i_ToString_i_uint8_i_to__string(neg8__3)
    var t12 string = t10 + t11
    var t13 string = t12 + "; "
    var t14 string = _goml_m_trait__impl_i_ToString_i_uint16_i_to__string(diff16__7)
    var t15 string = t13 + t14
    var t16 string = t15 + "; "
    var t17 string = _goml_m_trait__impl_i_ToString_i_uint32_i_to__string(neg32__11)
    var t18 string = t16 + t17
    var t19 string = t18 + "; "
    var t20 string = _goml_m_trait__impl_i_ToString_i_uint64_i_to__string(diff64__15)
    var message__16 string = t19 + t20
...
func _goml_m_trait__impl_i_ToString_i_uint8_i_to__string(self__15 uint8) string {
    var retv22 string
    var t23 string = _goml_runtime_core_uint8_to_string(self__15)
    retv22 = t23
    return retv22
}
...
func _goml_m_trait__impl_i_ToString_i_uint16_i_to__string(self__16 uint16) string {
    var retv25 string
    var t26 string = _goml_runtime_core_uint16_to_string(self__16)
    retv25 = t26
    return retv25
}
...
func _goml_m_trait__impl_i_ToString_i_uint32_i_to__string(self__17 uint32) string {
    var retv28 string
    var t29 string = _goml_runtime_core_uint32_to_string(self__17)
    retv28 = t29
    return retv28
}
...
func _goml_m_trait__impl_i_ToString_i_uint64_i_to__string(self__18 uint64) string {
    var retv31 string
    var t32 string = _goml_runtime_core_uint64_to_string(self__18)
    retv31 = t32
    return retv31
}
