...
func sum_and_tag__Q_int32__T_int32(tag__38 int32, x__39 int32, y__40 int32, z__41 int32) string {
    var retv93 string
    var t94 int32 = _goml_trait_x5f_impl_x23_Add_x23_int32_x23_add(x__39, y__40)
    var total__42 int32 = _goml_trait_x5f_impl_x23_Add_x23_int32_x23_add(t94, z__41)
    ...
    var t96 string = _goml_trait_x5f_impl_x23_Inspect_x23_int32_x23_inspect(total__42)
...
func sum_and_tag__Q_Boxed__T_Boxed(tag__38 Boxed, x__39 Boxed, y__40 Boxed, z__41 Boxed) string {
    var retv102 string
    var t103 Boxed = _goml_trait_x5f_impl_x23_Add_x23_Boxed_x23_add(x__39, y__40)
    var total__42 Boxed = _goml_trait_x5f_impl_x23_Add_x23_Boxed_x23_add(t103, z__41)
    ...
    var t105 string = _goml_trait_x5f_impl_x23_Inspect_x23_Boxed_x23_inspect(total__42)
...
func combine_scaled__T_int32(a__23 int32, b__24 int32, factor__25 int32) int32 {
    var retv111 int32
    var t112 int32 = _goml_trait_x5f_impl_x23_Add_x23_int32_x23_add(a__23, b__24)
    var t113 int32 = _goml_trait_x5f_impl_x23_Scale_x23_int32_x23_scale(t112, factor__25)
    retv111 = t113
    return retv111
}
...
func combine_scaled__T_Boxed(a__23 Boxed, b__24 Boxed, factor__25 int32) Boxed {
    var retv125 Boxed
    var t126 Boxed = _goml_trait_x5f_impl_x23_Add_x23_Boxed_x23_add(a__23, b__24)
    var t127 Boxed = _goml_trait_x5f_impl_x23_Scale_x23_Boxed_x23_scale(t126, factor__25)
    retv125 = t127
    return retv125
}
...
func tag_text__Q_int32(tag__22 int32) string {
    var retv139 string
    var t140 string = _goml_trait_x5f_impl_x23_Debug_x23_int32_x23_show(tag__22)
    var t141 string = t140 + "#"
    var t142 int32 = _goml_trait_x5f_impl_x23_MyHash_x23_int32_x23_hash(tag__22)
...
func tag_text__Q_Boxed(tag__22 Boxed) string {
    var retv146 string
    var t147 string = _goml_trait_x5f_impl_x23_Debug_x23_Boxed_x23_show(tag__22)
    var t148 string = t147 + "#"
    var t149 int32 = _goml_trait_x5f_impl_x23_MyHash_x23_Boxed_x23_hash(tag__22)
...
func show_both__T_int32(x__21 int32) string {
    var retv153 string
    var t154 string = _goml_trait_x5f_impl_x23_Debug_x23_int32_x23_show(x__21)
    var t155 string = t154 + " / "
    var t156 string = _goml_trait_x5f_impl_x23_Display_x23_int32_x23_show(x__21)
...
func show_both__T_Boxed(x__21 Boxed) string {
    var retv159 string
    var t160 string = _goml_trait_x5f_impl_x23_Debug_x23_Boxed_x23_show(x__21)
    var t161 string = t160 + " / "
    var t162 string = _goml_trait_x5f_impl_x23_Display_x23_Boxed_x23_show(x__21)
