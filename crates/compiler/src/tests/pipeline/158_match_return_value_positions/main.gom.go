...
func closure_after_match(flag__3 bool) int32 {
    ...
    var t19 int32 = _goml_m_inherent_i_closure__env__f__0_i_closure__env__f__0_i_apply(f__6, flag__3)
    retv18 = t19
    return retv18
}
...
func _goml_m_inherent_i_closure__env__f__0_i_closure__env__f__0_i_apply(env6 closure_env_f_0, inner__4 bool) int32 {
    var retv33 int32
    var jp35 int32
    switch inner__4 {
    case true:
