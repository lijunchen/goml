...
func main0() struct{} {
    ...
    Loop_loop12:
    for {
        var t13 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__1)
        var t14 bool = t13 < 20
        if t14 {
            var t15 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__1)
            var t16 int32 = t15 + 1
            _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(i__1, t16)
            var t21 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__1)
            var t22 bool = t21 > 5
            if t22 {
                break Loop_loop12
            } else {
                ...
                _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(sum__0, t20)
                continue
            }
        } else {
            break Loop_loop12
    ...
    print__T_string("sum: ")
    var t10 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(sum__0)
    println__T_int32(t10)
    print__T_string("i at break: ")
    var t11 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__1)
