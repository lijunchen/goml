...
func sum_to(limit__0 int32) int32 {
    ...
    var cond24 bool
    for {
        var t9 int32 = ref_get__Ref_int32(i__2)
        cond24 = t9 < limit__0
        if !cond24 {
            break
        }
        ...
        var t10 int32 = t11 + current__3
        ref_set__Ref_int32(acc__1, t10)
        var t12 int32 = current__3 + 1
        ref_set__Ref_int32(i__2, t12)
    }
    ret23 = ref_get__Ref_int32(acc__1)
    return ret23
}
...
func sum_even(limit__4 int32) int32 {
    ...
    ret25 = ref_get__Ref_int32(acc__5)
    return ret25
}
...
func main0() struct{} {
    ...
    var t20 string = int32_to_string(first__10)
    var t19 string = "sum_to(5)=" + t20
    string_println(t19)
    var t22 string = int32_to_string(evens__11)
    var t21 string = "sum_even(6)=" + t22
    string_println(t21)
    ret27 = struct{}{}
    return ret27
}
