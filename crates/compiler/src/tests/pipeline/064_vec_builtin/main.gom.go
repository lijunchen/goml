...
func main0() struct{} {
    ...
    var t15 string = int32_to_string(first__4)
    string_println(t15)
    var t16 string = int32_to_string(second__5)
    string_println(t16)
    var t17 string = int32_to_string(third__6)
    string_println(t17)
    var t18 string = int32_to_string(len__7)
    string_println(t18)
    ret19 = struct{}{}
    return ret19
}
