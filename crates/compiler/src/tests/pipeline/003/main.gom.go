...
func print__T_unit(value__0 struct{}) struct{} {
    var t67 string = _goml_m_trait__impl_i_ToString_i_unit_i_to__string(value__0)
    _goml_runtime_core_string_print(t67)
    return struct{}{}
}

func print__T_bool(value__0 bool) struct{} {
    var t70 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(value__0)
    _goml_runtime_core_string_print(t70)
    return struct{}{}
}

func print__T_int32(value__0 int32) struct{} {
    var t73 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(value__0)
...
func _goml_m_trait__impl_i_ToString_i_unit_i_to__string(self__35 struct{}) string {
    var retv76 string
    var t77 string = _goml_runtime_core_unit_to_string(self__35)
    retv76 = t77
    return retv76
}
...
func _goml_m_trait__impl_i_ToString_i_bool_i_to__string(self__36 bool) string {
    var retv79 string
    var t80 string = _goml_runtime_core_bool_to_string(self__36)
    retv79 = t80
    return retv79
}
