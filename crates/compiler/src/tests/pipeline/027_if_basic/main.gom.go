...
func main0() struct{} {
    ...
    var t11 string = _goml_m_inherent_i_int32_i_int32_i_to__string(yes__3)
    var t12 string = "yes=" + t11
    println__T_string(t12)
    var t13 string = _goml_m_inherent_i_int32_i_int32_i_to__string(no__4)
    var t14 string = "no=" + t13
