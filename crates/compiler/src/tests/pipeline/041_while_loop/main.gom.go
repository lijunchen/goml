...
func sum_to(limit__0 int32) int32 {
    ...
    Loop_loop14:
    for {
        var t15 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__2)
        ...
        if t16 {
            ...
            _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(acc__1, t18)
            var t19 int32 = current__3 + 1
            _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int32(i__2, t19)
            continue
        } else {
            break Loop_loop14
        }
    }
    var t13 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(acc__1)
    retv11 = t13
    return retv11
}
...
func sum_even(limit__4 int32) int32 {
    ...
    Loop_loop24:
    for {
        var t25 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(i__6)
    ...
    var t23 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__int32(acc__5)
    retv21 = t23
    return retv21
}
