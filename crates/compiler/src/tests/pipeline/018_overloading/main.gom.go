...
func impl_Arith_int32_add(self__0 int32, other__1 int32) int32 {
    var ret6 int32
    ret6 = self__0 + other__1
    return ret6
}

func impl_Arith_int32_less(self__2 int32, other__3 int32) bool {
    var ret7 bool
    ret7 = self__2 < other__3
    return ret7
}

func impl_ToString_int32_to_string(self__4 int32) string {
    var ret8 string
...
func impl_Output_int32_output(self__6 int32) struct{} {
    var ret10 struct{}
    var t4 string = impl_ToString_int32_to_string(self__6)
...
func main0() struct{} {
    ...
    var c__11 int32 = impl_Arith_int32_add(a__9, b__10)
    impl_Output_int32_output(c__11)
    var a__12 int32 = id__T_int32(3)
    var b__13 int32 = id__T_int32(4)
    var c__14 bool = impl_Arith_int32_less(a__12, b__13)
