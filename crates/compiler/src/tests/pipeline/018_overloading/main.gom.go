...
func _goml_m_trait__impl_i_Arith_i_int32_i_add(self__0 int32, other__1 int32) int32 {
    var retv12 int32
    var t13 int32 = self__0 + other__1
    retv12 = t13
    return retv12
}
...
func _goml_m_trait__impl_i_Arith_i_int32_i_less(self__2 int32, other__3 int32) bool {
    var retv15 bool
    var t16 bool = self__2 < other__3
    retv15 = t16
    return retv15
}

func _goml_m_trait__impl_i_Output_i_int32_i_output(self__4 int32) struct{} {
    var t18 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(self__4)
    println__T_string(t18)
    return struct{}{}
}

func _goml_m_trait__impl_i_Output_i_bool_i_output(self__5 bool) struct{} {
    var t21 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(self__5)
...
func _goml_m_trait__impl_i_ToString_i_bool_i_to__string(self__8 bool) string {
    var retv31 string
    var t32 string = _goml_runtime_core_bool_to_string(self__8)
    retv31 = t32
    return retv31
}
