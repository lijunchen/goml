...
func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_push____T__dynDisplay(self__94 *_goml_vec_Dyn_Display, elem__95 dyn__Display) struct{} {
    vec_push__Vec_11Dyn_Display(self__94, elem__95)
    return struct{}{}
}

func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_slice____T__dynDisplay(self__106 *_goml_vec_Dyn_Display, start__107 int32, end__108 int32) []dyn__Display {
    var retv48 []dyn__Display
    var t49 []dyn__Display = self__106.items[start__107:end__108]
    retv48 = t49
    return retv48
}
...
func _goml_m_inherent_i_Slice_i_Slice_l_T_r__i_sub____T__dynDisplay(self__118 []dyn__Display, start__119 int32, end__120 int32) []dyn__Display {
    var retv54 []dyn__Display
    var t55 []dyn__Display = self__118[start__119:end__120]
    retv54 = t55
    return retv54
}
