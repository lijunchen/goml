...
#[test]
fn multi_module_compile_001() -> anyhow::Result<()> {
    run_project("project001")
}

#[test]
fn multi_module_compile_project_002() -> anyhow::Result<()> {
    run_project("project002")
}

#[test]
fn multi_module_compile_project_003() -> anyhow::Result<()> {
    run_project("project003")
}

#[test]
fn multi_module_compile_project_004() -> anyhow::Result<()> {
    run_project("project004")
}

#[test]
fn multi_module_compile_project_005() -> anyhow::Result<()> {
    run_project("project005")
}

#[test]
fn multi_module_compile_project_006() -> anyhow::Result<()> {
    run_project("project006")
}

#[test]
fn multi_module_compile_project_007() -> anyhow::Result<()> {
...
#[test]
fn multi_module_compile_project_009() -> anyhow::Result<()> {
    run_project("project009_builtin_option_result")
}

#[test]
fn multi_module_compile_project_010() -> anyhow::Result<()> {
    run_project("project010_builtin_trait_show")
}

#[test]
fn multi_module_compile_project_011() -> anyhow::Result<()> {
    run_project("project011_complex_dependency_graph")
}

#[test]
fn multi_module_compile_project_012() -> anyhow::Result<()> {
...
#[test]
fn multi_module_compile_project_015() -> anyhow::Result<()> {
...
#[test]
fn multi_module_compile_project_018() -> anyhow::Result<()> {
...
#[test]
fn multi_module_compile_project_021() -> anyhow::Result<()> {
    run_project("project021_library_main_function")
}

#[test]
fn multi_module_compile_project_022() -> anyhow::Result<()> {
