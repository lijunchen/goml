...
impl Rename {
    ...
    fn rename_expr(
        ...
        match expr {
            ...
            ast::Expr::EInt8 { .. } => expr.clone(),
            ast::Expr::EInt16 { .. } => expr.clone(),
            ast::Expr::EInt32 { .. } => expr.clone(),
            ast::Expr::EInt64 { .. } => expr.clone(),
            ast::Expr::EUInt8 { .. } => expr.clone(),
            ast::Expr::EUInt16 { .. } => expr.clone(),
            ast::Expr::EUInt32 { .. } => expr.clone(),
            ast::Expr::EUInt64 { .. } => expr.clone(),
            ast::Expr::EFloat { .. } => expr.clone(),
            ast::Expr::EFloat32 { .. } => expr.clone(),
            ast::Expr::EFloat64 { .. } => expr.clone(),
    ...
    fn rename_pat(&self, pat: &ast::Pat, env: &mut Env) -> ast::Pat {
        match pat {
            ...
            ast::Pat::PInt8 { .. } => pat.clone(),
            ast::Pat::PInt16 { .. } => pat.clone(),
            ast::Pat::PInt32 { .. } => pat.clone(),
            ast::Pat::PInt64 { .. } => pat.clone(),
            ast::Pat::PUInt8 { .. } => pat.clone(),
            ast::Pat::PUInt16 { .. } => pat.clone(),
            ast::Pat::PUInt32 { .. } => pat.clone(),
            ast::Pat::PUInt64 { .. } => pat.clone(),
