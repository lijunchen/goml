...
macro_rules! T {
    ...
    [super] => { $crate::TokenKind::SuperKeyword };
    ...
    [break] => { $crate::TokenKind::BreakKeyword };
    [continue] => { $crate::TokenKind::ContinueKeyword };
    ...
    [Uint] => { $crate::TokenKind::UintKeyword };
