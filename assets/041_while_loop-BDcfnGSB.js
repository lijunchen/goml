const e = `fn sum_to(limit: int32) -> int32 {
  let acc = ref(0);
  let i = ref(0);
  let _ = (while int32_less(ref_get(i), limit) {
...
fn main() {
  ...
  let _ = string_println(string_add("sum_to(5)=", int32_to_string(first)));
  let _ = string_println(string_add("sum_even(6)=", int32_to_string(evens)));
  ()
}
`;
export {
