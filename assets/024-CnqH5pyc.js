...
fn point32_to_string(p: Point) -> string {
  let Point {x : x, y: y} = p;
  string_add("Point { x: ", string_add(int32_to_string(x), string_add(", y: ", string_add(int32_to_string(y), " }"))))
}
...
fn line_to_string(l: Line) -> string {
  ...
  string_add("Line { from: ", string_add(point32_to_string(from), string_add(", to: ", string_add(point32_to_string(to), string_add(", color: ", string_add(color_to_string(color), " }"))))))
}
