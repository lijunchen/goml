...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  `
      ...
      const Vh = "/goml/assets/wasm_app_bg-Wb0dQAI8.wasm", Lh = async (f = {}, s) => {
        let y;
      ...
      const Ua = {}, o1 = async () => {
        ...
        const f = Object.assign({
          ...
          "../../crates/compiler/src/tests/examples/002_overloading.src": () => Mf(() => import("./002_overloading-DiaRRhWY.js"), []).then((s) => s.default),
          "../../crates/compiler/src/tests/examples/003_fib.src": () => Mf(() => import("./003_fib-DUgMF-IM.js"), []).then((s) => s.default)
        });
        for (const s in f) {
