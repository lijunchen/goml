...
fn main() {
    let tuple_first: int8 = 1;
    let tuple_second: int16 = 2;
    ...
    let part1 = report("int8=", is_special8(5));
    let part2 = report(",int16=", is_special16(1024));
    let part3 = report(",int32=", is_special32(8192));
            ...
            string_add(
                ...
                string_add(
                    ...
                    string_add(
                        ...
                        string_add(
                            part6,
                            string_add(part7, string_add(part8, part9)),
                        ),
                    ),
                ),
            ),
