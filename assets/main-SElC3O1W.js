...
fn main() {
    let _ = println(full_report(7, 10, 32));
    let _ = println(full_report(Boxed { value: 99 }, Boxed { value: 3 }, Boxed { value: 4 }));
    let _ = println(sum_and_tag(0, 1, 2, 3));
    let _ = println(sum_and_tag(Boxed { value: 1 }, Boxed { value: 5 }, Boxed { value: 6 }, Boxed { value: 7 }));
    ()
}
`;
export {
