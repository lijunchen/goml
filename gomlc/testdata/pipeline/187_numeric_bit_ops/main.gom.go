...
func signed_ops() struct{} {
    ...
    println__T_i16(t5)
    var t6 int16 = -32767 - 1
    var t7_rhs int = 15
    var t7 int16 = t6 >> t7_rhs
    println__T_i16(t7)
    var t8_lhs int16 = 1
    var t8_rhs int = 14
    ...
    println__T_i32(t10)
    var t11 int32 = -2147483647 - 1
    var t12_rhs int = 31
    var t12 int32 = t11 >> t12_rhs
    println__T_i32(t12)
    var t13_lhs int32 = 1
    var t13_rhs int = 30
...
func precedence() struct{} {
    ...
    var t0 uint8 = t0_lhs & t0_rhs
    var t1_lhs uint8 = 2
    var t1 uint8 = t1_lhs ^ t0
    var t2_lhs uint8 = 1
    var t2 uint8 = t2_lhs | t1
    println__T_u8(t2)
    var t3 int = 2 + 1
    var t4_lhs uint8 = 1
    var t4 uint8 = t4_lhs << t3
    println__T_u8(t4)
    var t5_lhs int = 1
    var t5_rhs int = 2
    ...
    var t12_rhs uint8 = 15
    var t12 uint8 = t11 & t12_rhs
    println__T_u8(t12)
    return struct{}{}
}
...
func main0() struct{} {
    ...
    var inline3_rhs uint8 = 15
    var inline3 uint8 = inline2 & inline3_rhs
    var inline4_lhs uint8 = 1
    var inline4_rhs int = 4
    var inline4 uint8 = inline4_lhs << inline4_rhs
    var inline5_rhs uint8 = 31
    var inline5 uint8 = inline4 % inline5_rhs
