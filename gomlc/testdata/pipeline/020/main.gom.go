...
func bounce_int(shape__0 Shape__int32) Shape__int32 {
    ...
    case 0:
        ...
        var t440 Shape__int32 = Shape__int32{
            _tag: 0,
            _v0_0: x411,
        }
        return t440
    case 1:
        var x412 Wrapper__int32 = shape__0._v1_0
        var t441 Shape__int32 = Shape__int32{
            _tag: 1,
            _v1_0: x412,
        }
        return t441
...
func shape_int32_to_string(shape__20 Shape__int32) string {
    ...
    case 0:
        ...
        var inline532 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline528)
        var inline533 string = "Point { x: " + inline532
        var inline534 string = inline533 + ", y: "
        var inline535 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline529)
        ...
        return t469
    case 1:
        var x423 Wrapper__int32 = shape__20._v1_0
        var t470 string
        var inline540 int32 = x423.value
        var inline542 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline540)
...
func shape_unit_to_string(shape__25 Shape__unit) string {
    ...
    case 0:
        ...
        var inline551 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline547)
        var inline552 string = "Point { x: " + inline551
        var inline553 string = inline552 + ", y: "
        var inline554 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline548)
...
func main0() struct{} {
    ...
    var t483 Wrapper__int32 = Wrapper__int32{
        value: 7,
    }
    ...
    var t490 Wrapper__int32 = Wrapper__int32{
        value: 7,
    }
    var t491 Shape__int32 = Shape__int32{
        _tag: 1,
        _v1_0: t490,
    }
