...
func main0() struct{} {
    ...
    var inline502 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline501)
    ...
    var inline484 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(number__13)
    _goml_runtime_core_string_println(inline484)
    var t441 Number = Number{
        value: 8,
    }
    var t442 int32
    var inline482 int32 = _goml_m_trait__impl_i_Source_i__l_int32_r__x40_Number_i_get(t441)
    t442 = inline482
    var inline479 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t442)
    _goml_runtime_core_string_println(inline479)
    var t443 Selected = Selected{
        value: 9,
    }
    var t444 int32
    var inline477 int32 = invoke__S_Selected__T_int32(t443)
    t444 = inline477
    var inline474 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t444)
