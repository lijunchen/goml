...
func main0() struct{} {
    ...
    var inline3 int32 = 1
    var inline4 string = "x"
    var inline5 Tuple2_5int32_6string = Tuple2_5int32_6string{
        _0: inline3,
        _1: inline4,
    }
    value__0 = inline5
    var t0 int32 = value__0._0
    var t1 string
    var inline2 string = __goml_builtin_int32_to_string(t0)
    t1 = inline2
    var t2 string = value__0._1
    var t3 string = t1 + t2
