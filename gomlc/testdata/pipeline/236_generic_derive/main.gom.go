...
func main0() struct{} {
    ...
    var inline276 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t161)
    _goml_runtime_core_string_println(inline276)
    var t162 bool
    switch empty__27.(type) {
    case Value:
        var inline271 Wrapper__NoTraits = empty__27.(Value)._0
        var inline274 bool = _goml_m_trait__impl_i_Eq_i_Wrapper____NoTraits_i_eq(inline271, wrapped__24)
        t162 = inline274
    default:
        t162 = false
    }
    var t163 bool = !t162
    var inline264 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(t163)
    _goml_runtime_core_string_println(inline264)
    var t164 uint64
    var inline259 uint64 = 14695981039346656037 + 2
    var inline260 uint64 = inline259 * 1099511628211
    var inline261 uint64 = _goml_m_trait__impl_i_Hash_i_Wrapper____NoTraits_i_hash(wrapped__24)
    var inline262 uint64 = inline260 + inline261
    t164 = inline262
    var t165 uint64
    var inline251 uint64 = 14695981039346656037 + 2
    var inline252 uint64 = inline251 * 1099511628211
    var inline253 uint64 = _goml_m_trait__impl_i_Hash_i_Wrapper____NoTraits_i_hash(wrapped__24)
    var inline254 uint64 = inline252 + inline253
    t165 = inline254
    var t166 bool
    var inline246 bool = t164 == t165
    t166 = inline246
    var inline243 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(t166)
...
func println__T_bool(value__31 bool) struct{} {
    var t182 string
    var inline284 string = _goml_runtime_core_bool_to_string(value__31)
    t182 = inline284
...
func _goml_m_trait__impl_i_Hash_i_Generic____NoTraits____NoTraits_i_hash(self__9 Generic__NoTraits__NoTraits) uint64 {
    ...
    var t198 uint64 = h__10 * 1099511628211
    var t200 uint64
    t200 = 7
    var h__11 uint64 = t198 + t200
    var t201 uint64 = h__11 * 1099511628211
    var t203 uint64
    t203 = 7
    var h__12 uint64 = t201 + t203
    return h__12
}
...
func _goml_m_trait__impl_i_ToString_hfd40b94e3e10293076a83269859fcdb0_ts_i_to__string(self__13 GenericChoice__NoTraits__NoTraits) string {
    ...
    case Value:
        var t211 string
        t211 = "wrapped"
        var t212 string = "GenericChoice::Value(" + t211
