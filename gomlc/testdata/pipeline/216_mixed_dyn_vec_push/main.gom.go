...
func _goml_m_trait__impl_i_Show_i_Wrap_i_show(self__0 Wrap) string {
    var t0 string = self__0.value
    return t0
}

func main0() struct{} {
    var values__0 *_goml_vec_Dyn_Show
    var inline6 *_goml_vec_Dyn_Show = vec_new__Vec_8Dyn_Show()
    values__0 = inline6
    var value__0 int32 = 10
    var t0 dyn__Show = dyn__Show{
        data: int32(value__0),
        vtable: dyn__Show__vtable__int32(),
    }
    vec_push__Vec_8Dyn_Show(values__0, t0)
    var t1 Wrap = Wrap{
        value: "ok",
    }
    var t2 dyn__Show = dyn__Show{
        data: t1,
        vtable: dyn__Show__vtable__Wrap(),
    }
    vec_push__Vec_8Dyn_Show(values__0, t2)
    var t3 dyn__Show = vec_get__Vec_8Dyn_Show(values__0, 0)
    var t4 string = t3.vtable.show(t3.data)
    var inline2 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t4)
    _goml_runtime_core_string_println(inline2)
    var t5 dyn__Show = vec_get__Vec_8Dyn_Show(values__0, 1)
    var t6 string = t5.vtable.show(t5.data)
