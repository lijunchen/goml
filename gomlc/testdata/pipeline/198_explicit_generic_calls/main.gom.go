...
func main0() struct{} {
    var t0 string
    var inline6 string = "direct"
    t0 = inline6
    var inline4 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t0)
    _goml_runtime_core_string_println(inline4)
    var t1 int32
    var inline3 int32 = 42
    t1 = inline3
    var t2 string
    var inline2 string = __goml_builtin_int32_to_string(t1)
    t2 = inline2
