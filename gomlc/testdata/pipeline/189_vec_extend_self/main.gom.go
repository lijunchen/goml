...
func print_values(values__0 *_goml_vec_int32) struct{} {
    var t169 int = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_len____T__int32(values__0)
    println__T_int(t169)
    var for_source153 *_goml_vec_int32 = values__0
    var for_limit154 int = vec_len__Vec_5int32(for_source153)
    var for_index155 int = 0
    Loop_loop171:
    for {
        var t172 bool = for_index155 < for_limit154
        if t172 {
            var for_item156 int32 = vec_get__Vec_5int32(for_source153, for_index155)
            var t173 int = for_index155 + 1
            for_index155 = t173
            var value__1 int32 = for_item156
...
func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_len____T__int32(self__137 *_goml_vec_int32) int {
    var retv181 int
    var t182 int = vec_len__Vec_5int32(self__137)
    retv181 = t182
    return retv181
}
...
func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_extend____T__int32(self__171 *_goml_vec_int32, other__172 *_goml_vec_int32) struct{} {
    ...
    Loop_loop193:
    for {
        var t194 bool = index__174 < len__173
        if t194 {
            var t195 int32 = vec_get__Vec_5int32(other__172, index__174)
            _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_push____T__int32(self__171, t195)
            var compound_old96 int = index__174
            var compound_value97 int = 1
            var t196 int = compound_old96 + compound_value97
            index__174 = t196
            continue
        } else {
            break Loop_loop193
...
func _goml_m_trait__impl_i_ToString_i_int_i_to__string(self__40 int) string {
    var retv199 string
    var t200 string = _goml_runtime_core_int_to_string(self__40)
    retv199 = t200
    return retv199
}
...
func _goml_m_trait__impl_i_ToString_i_int32_i_to__string(self__43 int32) string {
    var retv202 string
    var t203 string = _goml_runtime_core_int32_to_string(self__43)
    retv202 = t203
    return retv202
}
