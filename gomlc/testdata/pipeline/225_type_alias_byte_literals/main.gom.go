...
func main0() struct{} {
    ...
    var inline488 string = _goml_m_trait__impl_i_ToString_i_u64_i_to__string(user__2)
    ...
    t433 = inline486
    var inline481 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t433)
    _goml_runtime_core_string_println(inline481)
    var inline478 string = _goml_m_trait__impl_i_ToString_i_u8_i_to__string(marker__4)
