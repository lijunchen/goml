...
func main0() struct{} {
    ...
    var t0 int32
    var inline4 int32 = _goml_m_trait__impl_i_Extra_i_i32_i_extra(first__0)
    t0 = inline4
    var inline2 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t0)
...
func _goml_m_trait__impl_i_Extra_i_i32_i_extra(self__0 int32) int32 {
    return 42
}
