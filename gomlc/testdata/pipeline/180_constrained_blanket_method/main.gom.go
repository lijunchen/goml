...
func main0() struct{} {
    ...
    var t181 int32
    var inline202 int32 = _goml_m_trait__impl_i_Extra_i_int32_i_extra(first__3)
    t181 = inline202
    var inline199 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t181)
    _goml_runtime_core_string_println(inline199)
    var t182 int32
    t182 = 42
    var inline195 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t182)
