...
func main0() struct{} {
    ...
    var t800 int32
    var inline864 int32 = _goml_m_trait__impl_i_Extra_i_i32_i_extra(first__3)
    t800 = inline864
    var inline861 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t800)
    _goml_runtime_core_string_println(inline861)
    var t801 int32
    t801 = 42
    var inline857 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t801)
    _goml_runtime_core_string_println(inline857)
    return struct{}{}
}

func _goml_m_trait__impl_i_Extra_i_i32_i_extra(self__1 int32) int32 {
    return 42
}

func _goml_m_trait__impl_i_ToString_i_i32_i_to__string(self__407 int32) string {
    var inline869 int64 = int64(int32(self__407))
    var inline870 string = signed_decimal_string(inline869)
    return inline870
}
