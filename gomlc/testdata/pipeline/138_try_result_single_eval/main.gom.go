...
func use_try(counter__2 *ref_int32_x, ok__3 bool) Result__i32__string {
    var mtmp412 Result__i32__string
    var inline484 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__i32(counter__2)
    var inline485 int32 = inline484 + 1
    _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__i32(counter__2, inline485)
    if ok__3 {
        var inline487 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__i32(counter__2)
        var inline488 Result__i32__string = Result__i32__string{
            _tag: 0,
            _v0_0: inline487,
        }
        mtmp412 = inline488
    } else {
        var inline489 Result__i32__string = Result__i32__string{
            _tag: 1,
            _v1_0: "bump failed",
        }
        mtmp412 = inline489
    ...
    case 0:
        ...
        var t434 Result__i32__string = Result__i32__string{
            _tag: 0,
            _v0_0: t433,
        }
        return t434
    case 1:
        ...
        var t435 Result__i32__string = Result__i32__string{
            _tag: 1,
            _v1_0: x414,
        }
        return t435
...
func main0() struct{} {
    ...
    var inline537 *ref_int32_x = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_new____T__i32(0)
    var inline538 Result__i32__string = use_try(inline537, inline536)
    var inline539 string = show(inline538)
    var inline540 string = inline539 + " count="
    var inline541 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__i32(inline537)
    var inline542 string = _goml_m_inherent_i_i32_i_i32_i_to__string(inline541)
    ...
    var inline525 *ref_int32_x = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_new____T__i32(0)
    var inline526 Result__i32__string = use_try(inline525, inline524)
    var inline527 string = show(inline526)
    var inline528 string = inline527 + " count="
    var inline529 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__i32(inline525)
