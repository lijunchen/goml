...
func then_break_outer_continue(flag__0 bool) int {
    ...
    for {
        ...
        if t1 {
            var inline1 int = 1
            ref_set__Ref_3int(rounds__0, inline1)
            Loop_loop_expr1:
            for {
                if flag__0 {
                    var t2 int
...
func then_break_outer_break(flag__0 bool) int {
    var state__0 *ref_int_x
    var inline1 int = 1
    var inline2 *ref_int_x = ref__Ref_3int(inline1)
    state__0 = inline2
    var jp0 int
    Loop_loop_expr1:
    for {
        if flag__0 {
            var t0 int
            var inline0 int = ref_get__Ref_3int(state__0)
            t0 = inline0
            var t1 bool = t0 == 1
            if t1 {
                break Loop_loop_expr1
...
func else_break_outer_continue(flag__0 bool) int {
    var rounds__0 *ref_int_x
    var inline4 int = 0
    var inline5 *ref_int_x = ref__Ref_3int(inline4)
    rounds__0 = inline5
...
func else_break_outer_break(flag__0 bool) int {
    var state__0 *ref_int_x
    var inline1 int = 1
    var inline2 *ref_int_x = ref__Ref_3int(inline1)
    state__0 = inline2
