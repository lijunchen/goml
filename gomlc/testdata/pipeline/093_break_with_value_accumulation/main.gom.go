...
func main0() struct{} {
    ...
    var inline21 int = 0
    var inline22 *ref_int_x = ref__Ref_3int(inline21)
    sum__0 = inline22
    var i__0 *ref_int_x
    var inline19 int = 0
    ...
    for {
        ...
        if t3 {
            ...
            if t7 {
                ...
                var t8 int
                var inline14 int = ref_get__Ref_3int(sum__0)
                t8 = inline14
                var t9 int
                var inline13 int = ref_get__Ref_3int(i__0)
                t9 = inline13
                var t10 int = t8 + t9
                ref_set__Ref_3int(sum__0, t10)
                continue
            }
        } else {
            break Loop_loop0
