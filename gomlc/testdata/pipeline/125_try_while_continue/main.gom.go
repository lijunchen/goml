...
func accumulate(limit__0 int32) Option__i32 {
    ...
    for {
        ...
        t2 = inline8
        var t3 bool = t2 < limit__0
        if t3 {
            var cur__0 int32
            var inline7 int32 = ref_get__Ref_5int32(i__0)
            cur__0 = inline7
            var t4_rhs int32 = 1
            var t4 int32 = cur__0 + t4_rhs
            ref_set__Ref_5int32(i__0, t4)
            var t5 bool = cur__0 == 1
            if t5 {
                continue
            } else {
                ...
                if inline3 {
                    ...
                    var inline4_rhs int32 = 10
                    var inline4 int32 = cur__0 + inline4_rhs
