...
func main0() struct{} {
    ...
    var t71 bool = ptr_eq__Ref_3int(a__0, b__1)
    println__T_bool(t71)
    var t72 bool = ptr_eq__Ref_3int(a__0, c__2)
    println__T_bool(t72)
    return struct{}{}
}

func _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_new____T__int(value__207 int) *ref_int_x {
    var retv74 *ref_int_x
    var t75 *ref_int_x = ref__Ref_3int(value__207)
    retv74 = t75
    return retv74
}

func println__T_bool(value__1 bool) struct{} {
    var t77 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(value__1)
