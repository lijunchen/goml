            ...
            if t411 {
                ...
                if t418 {
                    ...
                    if t425 {
                        ...
                        _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int(i__31, x170)
                        continue
                    }
                }
            }
    ...
    for {
        ...
        if jp468 {
            ...
            default:
                ...
                _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int(i__49, x186)
                continue
            }
        } else {
            break Loop_loop466
...
func parse_program(tokens__60 *_goml_vec_Token) *_goml_vec_SExpr {
    ...
    for {
        ...
        if t509 {
            ...
            _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__int(i__61, x198)
            continue
        } else {
            break Loop_loop506
        }
...
func value_to_string(value__66 Value) string {
    ...
    case Value_Int:
        ...
        var t518 string = _goml_m_inherent_i_int32_i_int32_i_to__string(x201)
        return t518
    case Value_Bool:
        var x202 bool = value__66.(Value_Bool)._0
        var t519 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(x202)
        return t519
    case Func:
        return "<lambda>"
    case Nil:
...
func truthy(value__69 Value) bool {
    ...
    case Value_Int:
        ...
        var t524 bool = _goml_m_trait__impl_i_Eq_i_int32_i_eq(x204, 0)
        var t525 bool = !t524
        return t525
    case Value_Bool:
...
func eval(expr__72 SExpr, local__73 *_goml_vec_Binding, global__74 *ref_Vec_7Binding_x) Value {
    ...
    case SExpr_Sym:
        ...
        var t533 Value = lookup(local__73, t532, x209)
        return t533
    case List:
        var x210 *_goml_vec_SExpr = expr__72.(List)._0
        var t534 Value = eval_list(x210, local__73, global__74)
        return t534
    default:
        panic("non-exhaustive match")
    }
...
func eval_list(items__79 *_goml_vec_SExpr, local__80 *_goml_vec_Binding, global__81 *ref_Vec_7Binding_x) Value {
    ...
    if t540 {
        ...
        case SExpr_Sym:
            ...
            var t543 Value = eval_list_sym(x213, items__79, local__80, global__81)
            return t543
        default:
        ...
        if t643 {
            ...
            case Value_Int:
                ...
                case Value_Int:
                    ...
                    var t650 bool = _goml_m_trait__impl_i_Eq_i_int32_i_eq(x243, x240)
            ...
            case Value_Bool:
                ...
                case Value_Bool:
                    ...
                    var t655 bool = _goml_m_trait__impl_i_Eq_i_bool_i_eq(x247, x241)
