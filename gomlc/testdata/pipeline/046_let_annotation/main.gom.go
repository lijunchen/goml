...
func main0() struct{} {
    ...
    var inline441 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(x__0)
    ...
    var inline434 string = _goml_m_trait__impl_i_ToString_i_int8_i_to__string(y__1)
