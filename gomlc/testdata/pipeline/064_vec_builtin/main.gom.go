...
func main0() struct{} {
    ...
    var t116 string = _goml_m_inherent_i_int32_i_int32_i_to__string(first__1)
    println__T_string(t116)
    var t117 string = _goml_m_inherent_i_int32_i_int32_i_to__string(second__2)
    println__T_string(t117)
    var t118 string = _goml_m_inherent_i_int32_i_int32_i_to__string(third__3)
    println__T_string(t118)
    var t119 string = _goml_m_inherent_i_int_i_int_i_to__string(len__4)
    println__T_string(t119)
    return struct{}{}
}

func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_new____T__int32() *_goml_vec_int32 {
    var retv121 *_goml_vec_int32
    var t122 *_goml_vec_int32 = vec_new__Vec_5int32()
    retv121 = t122
    return retv121
}
...
func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_len____T__int32(self__137 *_goml_vec_int32) int {
    var retv126 int
    var t127 int = vec_len__Vec_5int32(self__137)
    retv126 = t127
    return retv126
}
...
func _goml_m_inherent_i_int_i_int_i_to__string(self__5 int) string {
    var retv135 string
    var t136 string = _goml_runtime_core_int_to_string(self__5)
    retv135 = t136
    return retv135
}
