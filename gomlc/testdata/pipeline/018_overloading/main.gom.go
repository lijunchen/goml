...
func main0() struct{} {
    ...
    b__0 = inline9
    var c__0 int32
    var inline8 int32 = a__0 + b__0
    c__0 = inline8
    var inline6 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(c__0)
    ...
    b__1 = inline4
    var c__1 bool
    var inline3 bool = a__1 < b__1
    c__1 = inline3
    var inline1 string = _goml_m_trait__impl_i_ToString_i_bool_i_to__string(c__1)
