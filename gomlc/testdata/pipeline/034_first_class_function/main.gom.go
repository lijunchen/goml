...
func compose(f__4 func(int32) int32, g__5 func(int32) int32, value__6 int32) int32 {
    var retv169 int32
    var t170 int32 = g__5(value__6)
    var t171 int32 = f__4(t170)
    retv169 = t171
    return retv169
}
...
func main0() struct{} {
    ...
    var t173 string = _goml_m_inherent_i_int32_i_int32_i_to__string(composed__9)
    printer__20(t173)
    var t174 string = _goml_m_inherent_i_int32_i_int32_i_to__string(closure_result__12)
    printer__20(t174)
    var t175 string = _goml_m_inherent_i_int32_i_int32_i_to__string(invoked_with_global__16)
    printer__20(t175)
    var t176 string = _goml_m_inherent_i_int32_i_int32_i_to__string(composed_by_closure__19)
    printer__20(t176)
    return struct{}{}
}
...
func _goml_m_inherent_i_closure__en_haa892b00b0eb7ffc029d576cdd67daaf_pply__0_i_apply(env156 closure_env_closure_apply_0, value__10 int32) int32 {
    var retv186 int32
    var t187 int32 = apply_once(increment, value__10)
    retv186 = t187
    return retv186
}

func _goml_m_inherent_i_closure__en_h3286eba341bf64dee5b16b571aed9928_oker__1_i_apply(env157 closure_env_global_invoker_1, func_to_call__13 func(int32) int32, value__14 int32) int32 {
    var retv189 int32
    var t190 int32 = apply_once(func_to_call__13, value__14)
    retv189 = t190
    return retv189
}

func _goml_m_inherent_i_closure__en_h55d634371047d8dd612a447303ccba2c_sure__2_i_apply(env158 closure_env_composer_closure_2, value__17 int32) int32 {
    var retv192 int32
    var t193 int32 = compose(double, increment, value__17)
    retv192 = t193
    return retv192
}
