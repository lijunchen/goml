...
func maybe_total(flag__2 bool) Option__int32 {
    ...
    if flag__2 {
        var inline462 Option__int32 = Option__int32{
            _tag: 1,
            _v1_0: 3,
        }
        mtmp411 = inline462
    ...
    case 1:
        ...
        if inline458 {
            ...
            var inline460 Option__int32 = Option__int32{
                _tag: 1,
                _v1_0: inline459,
            }
            mtmp413 = inline460
        ...
        case 1:
            ...
            var t437 Option__int32 = Option__int32{
                _tag: 1,
                _v1_0: t436,
            }
            return t437
...
func main0() struct{} {
    var t445 Option__int32 = maybe_total(true)
    var t446 string
    switch t445._tag {
    case 0:
        t446 = "none"
    ...
    var t447 Option__int32 = maybe_total(false)
    var t448 string
    switch t447._tag {
    case 0:
        t448 = "none"
    case 1:
        ...
        var inline471 string = _goml_m_inherent_i_int32_i_int32_i_to__string(inline469)
