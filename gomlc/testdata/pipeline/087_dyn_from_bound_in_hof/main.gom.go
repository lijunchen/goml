...
type closure_env_mk_renderer_T_i32_0 struct {
    d_0 dyn__Display
}
...
func _goml_m_trait__impl_i_Display_i_i32_i_show(self__0 int32) string {
    var inline862 string = __goml_builtin_int32_to_string(self__0)
    return inline862
}
...
func main0() struct{} {
    ...
    var inline867 dyn__Display = dyn__Display{
        data: int32(value__3),
        vtable: dyn__Display__vtable__int32(),
    }
    var inline868 closure_env_mk_renderer_T_i32_0 = closure_env_mk_renderer_T_i32_0{
        d_0: inline867,
    }
    var inline869 func() string = func() string {
        return _goml_m_inherent_i_closure__en_h18731f7f562c77331e6106f5b16997ce__i32__0_i_apply(inline868)
    }
    f__4 = inline869
    var t802 string = f__4()
...
func _goml_m_inherent_i_closure__en_h18731f7f562c77331e6106f5b16997ce__i32__0_i_apply(env797 closure_env_mk_renderer_T_i32_0) string {
    var d__2 dyn__Display = env797.d_0
    var t860 string = d__2.vtable.show(d__2.data)
    return t860
}
