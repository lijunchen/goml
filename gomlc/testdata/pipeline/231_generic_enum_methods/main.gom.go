...
func main0() struct{} {
    ...
    var commute_field0 string
    var inline2 int = 3
    var inline3 string = t1(inline2)
    commute_field0 = inline3
    var inline0 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(commute_field0)
...
func _goml_m_inherent_i_closure__env__main__0_i_closure__env__main__0_i_apply(env0 closure_env_main_0, item__0 int) string {
    var inline0 string = __goml_builtin_int_to_string(item__0)
    return inline0
}
