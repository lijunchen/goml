...
func fetch(flag__0 bool) Option__int32 {
    ...
    var inline237 *hashmap_string_int32_x = hashmap_new__HashMap_6string_5int32()
    m__1 = inline237
    if flag__0 {
        var inline230 string = "a"
        var inline231 int32 = 7
        hashmap_set__HashMap_6string_5int32(m__1, inline230, inline231)
    } else {}
    var mtmp184 Option__int32
    var inline234 string = "a"
    var inline235 Option__int32 = hashmap_get__HashMap_6string_5int32(m__1, inline234)
    mtmp184 = inline235
    var jp193 int32
    switch mtmp184.(type) {
    case None:
...
func main0() struct{} {
    var t203 Option__int32 = fetch(true)
    var t204 string
    switch t203.(type) {
    case None:
        t204 = "none"
    case Some:
        var inline252 int32 = t203.(Some)._0
    ...
    var inline249 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t204)
    _goml_runtime_core_string_println(inline249)
    var t205 Option__int32 = fetch(false)
    var t206 string
    switch t205.(type) {
    case None:
        t206 = "none"
    case Some:
        var inline244 int32 = t205.(Some)._0
    ...
    var inline241 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t206)
...
func _goml_m_trait__impl_i_PartialEq_i_string_i_eq(self__97 string, other__98 string) bool {
    var t225 bool = self__97 == other__98
    return t225
}

func _goml_m_trait__impl_i_Hash_i_string_i_hash(self__125 string) uint64 {
    var t228 uint64 = _goml_runtime_core_string_hash(self__125)
    return t228
}
