...
func main0() struct{} {
    ...
    t423 = inline502
    var inline499 string = _goml_m_trait__impl_i_ToString_i_int_i_to__string(t423)
    _goml_runtime_core_string_println(inline499)
    var t424 int32
    var inline496 int = 0
    var inline497 int32 = s__1[inline496]
    t424 = inline497
    var inline493 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t424)
    _goml_runtime_core_string_println(inline493)
    var t425 int32
    var inline490 int = 1
    var inline491 int32 = s__1[inline490]
    t425 = inline491
    var inline487 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t425)
    _goml_runtime_core_string_println(inline487)
    var t426 int32
    var inline484 int = 2
    var inline485 int32 = s__1[inline484]
    t426 = inline485
    var inline481 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t426)
    ...
    t427 = inline475
    var inline472 string = _goml_m_trait__impl_i_ToString_i_int_i_to__string(t427)
    _goml_runtime_core_string_println(inline472)
    var t428 int32
    var inline469 int = 0
    var inline470 int32 = t__2[inline469]
    t428 = inline470
    var inline466 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t428)
    _goml_runtime_core_string_println(inline466)
    var t429 int32
    var inline463 int = 1
    var inline464 int32 = t__2[inline463]
    t429 = inline464
    var inline460 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t429)
