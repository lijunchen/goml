...
func _goml_m_trait__impl_i_Hash_i_Key_i_hash(self__0 Key) uint64 {
    ...
    case 2:
        ...
        var t9_rhs uint64 = 14695981039346656037
        var t9 uint64 = t8 + t9_rhs
        var h__3_rhs uint64 = 3
        var h__3 uint64 = t9 + h__3_rhs
        var t10_source int = 0
        var t10 uint64 = uint64(int(t10_source))
        var t11_rhs uint64 = 1099511628211
        var t11 uint64 = t10 + t11_rhs
        var t12 uint64 = h__3 * t11
        var t13 uint64
        var inline1_source int = 0
        var inline1 uint64 = uint64(int(inline1_source))
        var inline2_rhs uint64 = 14695981039346656037
        var inline2 uint64 = inline1 + inline2_rhs
        var inline3_source int = 0
        var inline3 uint64 = uint64(int(inline3_source))
        var inline4_rhs uint64 = 1099511628211
        ...
        var inline10_rhs uint64 = 1099511628211
        var inline10 uint64 = inline9 + inline10_rhs
