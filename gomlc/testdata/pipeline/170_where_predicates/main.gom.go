...
func main0() struct{} {
    ...
    var t0 string
    var inline8 string = _goml_m_trait__impl_i_Render_i_Vec_l_i32_r__i_render(values__0)
    t0 = inline8
    var inline6 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t0)
    _goml_runtime_core_string_println(inline6)
    var text__0 string
    var inline5 string = "equal"
    text__0 = inline5
    var inline3 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(text__0)
    _goml_runtime_core_string_println(inline3)
    var selected__0 Wrap__i32 = Wrap__i32{
        value: 7,
    }
    var t1 string
    var inline2 string = _goml_m_trait__impl_i_Selected_i_Wrap____i32_i_selected(selected__0)
    t1 = inline2
...
func _goml_m_trait__impl_i_Selected_i_Wrap____i32_i_selected(self__0 Wrap__i32) string {
    return "selected"
}
