...
func double(x__0 int32) int32 {
    var t413 int32 = x__0 * 2
    return t413
}

func increment(x__1 int32) int32 {
    var t416 int32 = x__1 + 1
    return t416
}
...
func main0() struct{} {
    ...
    var t422 int32 = f__4(10)
    var t423 int32 = g__5(t422)
    var inline456 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t423)
    _goml_runtime_core_string_println(inline456)
    var chosen__6 func(int32) int32
    var inline454 bool = true
    if inline454 {
        chosen__6 = double
    } else {
        chosen__6 = increment
    ...
    var direct__8 int32 = t424(5)
    var t425 string
    var inline450 string = _goml_runtime_core_int32_to_string(applied__7)
    t425 = inline450
    var inline447 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t425)
    _goml_runtime_core_string_println(inline447)
    var t426 string
    var inline445 string = _goml_runtime_core_int32_to_string(direct__8)
    t426 = inline445
    var inline442 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t426)
