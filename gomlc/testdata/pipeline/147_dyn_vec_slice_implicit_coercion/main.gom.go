...
func main0() struct{} {
    ...
    var inline14 *_goml_vec_Dyn_Display = vec_new__Vec_11Dyn_Display()
    v__0 = inline14
    var first__0 int32 = 10
    var second__0 int32 = 20
    var t0 dyn__Display = dyn__Display{
        data: int32(first__0),
        vtable: dyn__Display__vtable__int32(),
    }
    vec_push__Vec_11Dyn_Display(v__0, t0)
    var t1 dyn__Display = dyn__Display{
        data: int32(second__0),
        vtable: dyn__Display__vtable__int32(),
    }
    vec_push__Vec_11Dyn_Display(v__0, t1)
    var s__0 []dyn__Display
    var inline9 int = 0
    var inline10 int = 2
    var inline11 []dyn__Display = v__0.items[inline9:inline10]
    s__0 = inline11
    var t2 dyn__Display = s__0[0]
    var t3 string
    var inline8 string = t2.vtable.show(t2.data)
    t3 = inline8
    var inline6 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t3)
    _goml_runtime_core_string_println(inline6)
    var t__0 []dyn__Display
    var inline3 int = 1
    var inline4 int = 2
    var inline5 []dyn__Display = s__0[inline3:inline4]
    t__0 = inline5
    var t4 dyn__Display = t__0[0]
    var t5 string
    var inline2 string = t4.vtable.show(t4.data)
    t5 = inline2
