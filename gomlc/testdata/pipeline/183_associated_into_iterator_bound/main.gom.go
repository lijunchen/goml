...
func main0() struct{} {
    ...
    var inline8 *_goml_vec_int32 = vec_new__Vec_5int32()
    values__0 = inline8
    var inline6 int32 = 10
    vec_push__Vec_5int32(values__0, inline6)
    var inline4 int32 = 20
    vec_push__Vec_5int32(values__0, inline4)
    var inline2 int32 = 30
    vec_push__Vec_5int32(values__0, inline2)
    var t0 Numbers = Numbers{
        values: values__0,
    }
    var t1 int32 = count__B_Numbers(t0)
    var inline0 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t1)
    _goml_runtime_core_string_println(inline0)
    return struct{}{}
}

func count__B_Numbers(batch__0 Numbers) int32 {
    var total__0 *ref_int32_x
    var inline7 int32 = 0
    var inline8 *ref_int32_x = ref__Ref_5int32(inline7)
    total__0 = inline8
    var t0 *_goml_vec_int32
    var inline6 *_goml_vec_int32 = batch__0.values
    t0 = inline6
    var for_iter0 FnIterator__i32
    var inline5 FnIterator__i32 = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_iter____T__i32(t0)
    for_iter0 = inline5
    Loop_loop0:
    for {
