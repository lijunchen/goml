...
func main0() struct{} {
    ...
    var inline505 *_goml_vec_int32 = vec_new__Vec_5int32()
    values__3 = inline505
    var inline502 int32 = 10
    vec_push__Vec_5int32(values__3, inline502)
    var inline499 int32 = 20
    vec_push__Vec_5int32(values__3, inline499)
    var inline496 int32 = 30
    vec_push__Vec_5int32(values__3, inline496)
    var t425 Numbers = Numbers{
        values: values__3,
    }
...
func count__B_Numbers(batch__1 Numbers) int32 {
    ...
    var inline522 int32 = 0
    var inline523 *ref_int32_x = ref__Ref_5int32(inline522)
    total__2 = inline523
    ...
    for {
        ...
        case 1:
            var t442 int32
            var inline511 int32 = ref_get__Ref_5int32(total__2)
            t442 = inline511
            var t443 int32 = t442 + 1
            ref_set__Ref_5int32(total__2, t443)
            continue
        default:
            panic("non-exhaustive match")
        }
    }
    var inline516 int32 = ref_get__Ref_5int32(total__2)
    return inline516
}
...
func _goml_m_inherent_i_closure__en_hc2f7b05843f81f2ab8cf844432967a9e_nt32__0_i_apply(env420 closure_env_inherent_Vec_Vec_T_iter_T_int32_0) Option__int32 {
    ...
    var t489 bool = current__317 < len__316
    if t489 {
