...
func main0() struct{} {
    ...
    var inline266 *_goml_vec_int32 = vec_new__Vec_5int32()
    values__3 = inline266
    var inline263 int32 = 10
    vec_push__Vec_5int32(values__3, inline263)
    var inline260 int32 = 20
    vec_push__Vec_5int32(values__3, inline260)
    var inline257 int32 = 30
    vec_push__Vec_5int32(values__3, inline257)
    var t186 Numbers = Numbers{
        values: values__3,
    }
    var t187 int32 = count__B_Numbers(t186)
    var inline254 string = _goml_m_trait__impl_i_ToString_i_int32_i_to__string(t187)
...
func count__B_Numbers(batch__1 Numbers) int32 {
    ...
    var inline281 *_goml_vec_int32 = batch__1.values
    t198 = inline281
    var for_iter172 FnIterator__int32
    var inline279 FnIterator__int32 = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_iter____T__int32(t198)
    for_iter172 = inline279
    Loop_loop201:
    for {
        var for_next173 Option__int32
        var inline274 func() Option__int32 = for_iter172.next_fn
        var inline275 Option__int32 = inline274()
        for_next173 = inline275
        switch for_next173.(type) {
        case None:
            break Loop_loop201
        case Some:
            var t203 int32
            var inline272 int32 = ref_get__Ref_5int32(total__2)
            t203 = inline272
    ...
    var inline277 int32 = ref_get__Ref_5int32(total__2)
    return inline277
}
...
func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_iter____T__int32(self__228 *_goml_vec_int32) FnIterator__int32 {
    ...
    var inline292 FnIterator__int32 = FnIterator__int32{
        next_fn: t226,
    }
    return inline292
}
