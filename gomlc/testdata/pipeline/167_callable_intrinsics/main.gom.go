...
func main0() struct{} {
    var t0 string
    var inline25 int32 = 7
    var inline26 string = __goml_builtin_int32_to_string(inline25)
    t0 = inline26
    var inline23 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t0)
    _goml_runtime_core_string_println(inline23)
    var get__0 func(*_goml_vec_int32, int) int32 = vec_get__Vec_5int32
    var push__0 func(*_goml_vec_int32, int32) struct{} = vec_push__Vec_5int32
    var values__0 *_goml_vec_int32
    var inline22 *_goml_vec_int32 = vec_new__Vec_5int32()
    values__0 = inline22
    push__0(values__0, 11)
    push__0(values__0, 22)
    var t1 int32 = get__0(values__0, 1)
    var inline20 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t1)
    _goml_runtime_core_string_println(inline20)
    var make_slice__0 func(*_goml_vec_int32, int, int) []int32 = func(p0 *_goml_vec_int32, p1 int, p2 int) []int32 {
        return p0.items[p1:p2]
    }
    var slice_get_value__0 func([]int32, int) int32 = func(p0 []int32, p1 int) int32 {
        return p0[p1]
    }
    var view__0 []int32 = make_slice__0(values__0, 0, 2)
    var t2 int32 = slice_get_value__0(view__0, 0)
    var inline18 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t2)
    _goml_runtime_core_string_println(inline18)
    var inline16 int32 = 33
    vec_push__Vec_5int32(values__0, inline16)
    var t3 int
    var inline15 int = vec_len__Vec_5int32(values__0)
    t3 = inline15
    var inline13 string = _goml_m_trait__impl_i_ToString_i_isize_i_to__string(t3)
    _goml_runtime_core_string_println(inline13)
    var inline10 int = 0
    var inline11 int32 = 44
    vec_set__Vec_5int32(values__0, inline10, inline11)
    var t4 int32
    var inline8 int = 0
    var inline9 int32 = vec_get__Vec_5int32(values__0, inline8)
    t4 = inline9
    var inline6 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t4)
    _goml_runtime_core_string_println(inline6)
    var copied__0 *_goml_vec_int32 = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_pushed____T__i32(values__0, 55)
    var t5 int
    var inline5 int = vec_len__Vec_5int32(values__0)
    t5 = inline5
    var inline3 string = _goml_m_trait__impl_i_ToString_i_isize_i_to__string(t5)
    _goml_runtime_core_string_println(inline3)
    var t6 int
    var inline2 int = vec_len__Vec_5int32(copied__0)
    t6 = inline2
