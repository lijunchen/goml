...
func pair(ok__0 bool) _goml_m_Option_____o_string_c_string_q_ {
    if ok__0 {
...
func describe(ok__0 bool) Option__string {
    ...
    var inline0 _goml_m_Option_____o_string_c_string_q_ = cut_pair(ok__0)
    mtmp0 = inline0
...
func main0() struct{} {
    ...
    var inline5 _goml_m_Option_____o_string_c_string_q_ = pair(inline4)
