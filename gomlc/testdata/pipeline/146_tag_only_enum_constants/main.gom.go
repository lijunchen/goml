...
func main0() struct{} {
    var light__0 Light = Light_Red
    var paint__0 Paint = Paint_Red
    var t0 int32
    switch light__0 {
    case Light_Red:
        t0 = 10
    ...
    var t1 string
    var inline11 string = __goml_builtin_int32_to_string(t0)
    t1 = inline11
    ...
    var t3 string
    var inline8 string = __goml_builtin_int32_to_string(t2)
    t3 = inline8
    ...
    t4 = 30
    var t5 string
    var inline5 string = __goml_builtin_int32_to_string(t4)
    t5 = inline5
    ...
    t6 = 2
    var t7 string
    var inline2 string = __goml_builtin_int32_to_string(t6)
    t7 = inline2
