...
func main0() struct{} {
    ...
    var t70 string = _goml_m_trait__impl_i_ToString_i_int16_i_to__string(sum16__2)
    var t71 string = t70 + ", "
    var t72 string = _goml_m_trait__impl_i_ToString_i_int16_i_to__string(flipped16__3)
    var t73 string = t71 + t72
    var t74 string = t73 + "; "
    var t75 string = _goml_m_inherent_i_int32_i_int32_i_to__string(diff32__7)
    var t76 string = t74 + t75
    var t77 string = t76 + "; "
    var t78 string = _goml_m_trait__impl_i_ToString_i_int64_i_to__string(remain64__10)
    var t79 string = t77 + t78
    var t80 string = t79 + "; "
    var t81 string = _goml_m_trait__impl_i_ToString_i_int64_i_to__string(neg64__11)
    var message__12 string = t80 + t81
...
func _goml_m_trait__impl_i_ToString_i_int16_i_to__string(self__42 int16) string {
    var retv83 string
    var t84 string = _goml_runtime_core_int16_to_string(self__42)
    retv83 = t84
    return retv83
}
...
func _goml_m_trait__impl_i_ToString_i_int64_i_to__string(self__44 int64) string {
    var retv89 string
    var t90 string = _goml_runtime_core_int64_to_string(self__44)
    retv89 = t90
    return retv89
}
