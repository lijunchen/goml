...
func main0() struct{} {
    ...
    var delta16__0 int16 = 45
    var sum16__0 int16 = start16__0 + delta16__0
    var flipped16__0 int16 = -start16__0
    var base32__0 int32 = 100000
    var more32__0 int32 = 200000
    var sum32__0 int32 = base32__0 + more32__0
    var diff32__0 int32 = sum32__0 - base32__0
    var big64__0 int64 = 5000000000
    var step64__0 int64 = 2000000000
    var remain64__0 int64 = big64__0 - step64__0
    var neg64__0 int64 = -step64__0
    var t0 string
    var inline6 string = __goml_builtin_int16_to_string(sum16__0)
    t0 = inline6
    var t1_rhs string = ", "
    var t1 string = t0 + t1_rhs
    var t2 string
    var inline5 string = __goml_builtin_int16_to_string(flipped16__0)
    t2 = inline5
    var t3 string = t1 + t2
    var t4_rhs string = "; "
    var t4 string = t3 + t4_rhs
    var t5 string
    var inline4 string = __goml_builtin_int32_to_string(diff32__0)
    t5 = inline4
    var t6 string = t4 + t5
    var t7_rhs string = "; "
    var t7 string = t6 + t7_rhs
    var t8 string
    var inline3 string = __goml_builtin_int64_to_string(remain64__0)
    t8 = inline3
    var t9 string = t7 + t8
    var t10_rhs string = "; "
    var t10 string = t9 + t10_rhs
    var t11 string
    var inline2 string = __goml_builtin_int64_to_string(neg64__0)
    t11 = inline2
