...
func main0() struct{} {
    var t800 string
    var inline882 string = __goml_builtin_int_to_string(ANSWER)
    t800 = inline882
    var inline879 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t800)
    _goml_runtime_core_string_println(inline879)
    var t801 string
    var inline877 string = __goml_builtin_uint8_to_string(MASK)
    t801 = inline877
    var inline874 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t801)
    _goml_runtime_core_string_println(inline874)
    var inline871 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(GREETING)
    _goml_runtime_core_string_println(inline871)
    var t802 string
    var inline869 string = _goml_runtime_core_bool_to_string(ENABLED)
    t802 = inline869
    var inline866 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t802)
...
func __goml_builtin_uint8_to_string(value__228 uint8) string {
    var t824 uint64 = uint64(uint8(value__228))
    var t825 string = decimal_string(t824)
    return t825
}
