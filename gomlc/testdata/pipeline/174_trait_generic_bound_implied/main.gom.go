...
func _goml_m_trait__impl_i_Mark_i_i32_i_mark(self__0 int32) string {
    ...
    t0 = inline0
    var t1_lhs string = "marked:"
    var t1 string = t1_lhs + t0
    return t1
}

func _goml_m_trait__impl_i_Container_i__l_i32_r__x40_NumberBox_i_value(self__0 NumberBox) int32 {
    var t0 int32 = self__0.value
    return t0
}

func main0() struct{} {
    var t0 NumberBox = NumberBox{
        value: 7,
    }
    var t1 string
    var inline2 int32 = _goml_m_trait__impl_i_Container_i__l_i32_r__x40_NumberBox_i_value(t0)
    var inline3 string = _goml_m_trait__impl_i_Mark_i_i32_i_mark(inline2)
    t1 = inline3
