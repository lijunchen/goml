...
func main0() struct{} {
    ...
    var t421 string
    var inline440 int32 = _goml_m_trait__impl_i_Container_i__l_i32_r__x40_NumberBox_i_value(t420)
    var inline441 string = _goml_m_trait__impl_i_Mark_i_i32_i_mark(inline440)
    t421 = inline441
