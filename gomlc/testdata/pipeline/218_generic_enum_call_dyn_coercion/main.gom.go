...
func _goml_m_trait__impl_i_Show_i_Boxed____int32_i_show(self__0 Boxed__int32) string {
    ...
    case 0:
        ...
        var inline437 string = _goml_runtime_core_int32_to_string(x411)
        return inline437
    default:
...
func main0() struct{} {
    ...
    var t421 Boxed__int32
    var inline444 Boxed__int32 = Boxed__int32{
        _tag: 0,
        _v0_0: value__4,
    }
    t421 = inline444
    ...
    var t423 string
    var inline442 string = t422.vtable.show(t422.data)
    t423 = inline442
