...
func main0() struct{} {
    ...
    var t4 string
    var inline2 string = t2.vtable.show(t2.data)
    var inline3 string = inline2 + "-"
    var inline4 string = t3.vtable.show(t3.data)
