...
func _goml_m_inherent_i_std_p_bytes_p_Bytes_i_std_p_bytes_p_Bytes_i_to__string(self__0 _goml_m_std_p_bytes_p_Bytes) Result__string__string {
    var t0 *_goml_vec_uint8 = self__0.values
    var mtmp0 Tuple2_4bool_6string = string_from_utf8(t0)
...
func _goml_m_std_p_internal_p_host_p_eprint(value__0 string) struct{} {
    _goml_runtime_std_io_eprint(value__0)
    return struct{}{}
}

func _goml_m_std_p_fs_p_read__bytes(path__0 string) _goml_m_Result____std_p_bytes_p_Bytes____string {
    var mtmp0 Tuple3_4bool_10Vec_5uint8_6string
    var inline1 Tuple3_4bool_10Vec_5uint8_6string = _goml_runtime_std_fs_read_bytes(path__0)
    mtmp0 = inline1
    var x0 bool = mtmp0._0
    var x1 *_goml_vec_uint8 = mtmp0._1
    var x2 string = mtmp0._2
    if x0 {
        ...
        t0 = inline0
        var t1 _goml_m_Result____std_p_bytes_p_Bytes____string = _goml_m_Result____std_p_bytes_p_Bytes____string{
            _tag: 0,
            _v0_0: t0,
        }
        return t1
    } else {
        var t2 _goml_m_Result____std_p_bytes_p_Bytes____string = _goml_m_Result____std_p_bytes_p_Bytes____string{
            _tag: 1,
            _v1_0: x2,
        }
        return t2
...
func main0() struct{} {
    ...
    var inline11 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t4)
    _goml_m_std_p_internal_p_host_p_println(inline11)
    var t5 Result__string__string
    var inline5 string = "goml-self-host/nested/output.txt"
    var inline6 _goml_m_Result____std_p_bytes_p_Bytes____string = _goml_m_std_p_fs_p_read__bytes(inline5)
    switch inline6._tag {
    case 0:
        var inline7 _goml_m_std_p_bytes_p_Bytes = inline6._v0_0
        var inline8 Result__string__string = _goml_m_inherent_i_std_p_bytes_p_Bytes_i_std_p_bytes_p_Bytes_i_to__string(inline7)
        t5 = inline8
    case 1:
        var inline9 string = inline6._v1_0
        var inline10 Result__string__string = Result__string__string{
            _tag: 1,
            _v1_0: inline9,
        }
        t5 = inline10
