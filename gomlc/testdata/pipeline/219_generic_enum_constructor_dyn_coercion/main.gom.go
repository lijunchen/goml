...
func _goml_m_trait__impl_i_Show_i_Boxed____int32_i_show(self__0 Boxed__int32) string {
    switch self__0.(type) {
    case One:
        var x177 int32 = self__0.(One)._0
        var inline200 string = _goml_runtime_core_int32_to_string(x177)
        return inline200
    default:
...
func main0() struct{} {
    ...
    var t187 Boxed__int32 = One{
        _0: value__3,
    }
    var t188 dyn__Show = dyn__Show{
        data: t187,
        vtable: dyn__Show__vtable__Boxed__int32(),
    }
    var t189 string
    var inline205 string = t188.vtable.show(t188.data)
    t189 = inline205
    var inline202 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t189)
