...
func main0() struct{} {
    ...
    var t1 string
    var inline14 string = __goml_builtin_int_to_string(t0)
    t1 = inline14
    ...
    var t3 string
    var inline10 string = __goml_builtin_int_to_string(t2)
    t3 = inline10
    ...
    var t5 string
    var inline6 string = __goml_builtin_int_to_string(t4)
    t5 = inline6
    var inline4 string = _goml_m_trait__impl_i_ToString_i_string_i_to__string(t5)
    ...
    var t7 string
    var inline2 string = __goml_builtin_int_to_string(t6)
    t7 = inline2
