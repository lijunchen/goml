...
func main0() struct{} {
    ...
    var t445 Numbers
    var inline616 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__i32(builds__7)
    var inline617 int32 = inline616 + 1
    _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__i32(builds__7, inline617)
    var inline619 *_goml_vec_int32 = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_new____T__i32()
    _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_push____T__i32(inline619, 1)
    _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_push____T__i32(inline619, 2)
    _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_push____T__i32(inline619, 3)
    ...
    var inline613 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t446)
    _goml_runtime_core_string_println(inline613)
    var t447 int32
    var inline611 int32 = ref_get__Ref_5int32(builds__7)
    t447 = inline611
    var inline608 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t447)
    _goml_runtime_core_string_println(inline608)
    var t448 int32
    var inline606 int32 = ref_get__Ref_5int32(conversions__8)
    t448 = inline606
    var inline603 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t448)
    ...
    var t449 int32 = _goml_m_sum____S__Vec_l_i32_r_(values__9)
    var inline589 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t449)
    ...
    t450 = inline587
    var t451 int32 = _goml_m_sum____S__Slice_l_i32_r_(t450)
    var inline582 string = _goml_m_trait__impl_i_ToString_i_i32_i_to__string(t451)
...
func _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_iter____T__i32(self__314 *_goml_vec_int32) FnIterator__i32 {
    ...
    len__316 = inline633
    var t459 closure_env_inherent_Vec_Vec_T_iter_T_i32_0 = closure_env_inherent_Vec_Vec_T_iter_T_i32_0{
        index_0: index__315,
        len_1: len__316,
        self_2: self__314,
    }
    var t460 func() Option__i32 = func() Option__i32 {
        return _goml_m_inherent_i_closure__en_h1275f72f5de770912182f2a5cc7ddfae__i32__0_i_apply(t459)
    }
    var inline631 FnIterator__i32 = FnIterator__i32{
        next_fn: t460,
    }
    return inline631
}
...
func sum__S_Numbers(source__4 Numbers) int32 {
    ...
    total__5 = inline655
    var for_iter416 FnIterator__i32
    var inline646 *ref_int32_x = source__4.conversions
    var inline647 *ref_int32_x = source__4.conversions
    var inline648 int32 = _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_get____T__i32(inline647)
    var inline649 int32 = inline648 + 1
    _goml_m_inherent_i_Ref_i_Ref_l_T_r__i_set____T__i32(inline646, inline649)
    var inline651 *_goml_vec_int32 = source__4.values
    var inline652 FnIterator__i32 = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_iter____T__i32(inline651)
    for_iter416 = inline652
    Loop_loop477:
    for {
        var for_next417 Option__i32
        var inline641 func() Option__i32 = for_iter416.next_fn
        var inline642 Option__i32 = inline641()
...
func _goml_m_sum____S__Vec_l_i32_r_(source__4 *_goml_vec_int32) int32 {
    ...
    total__5 = inline669
    var for_iter416 FnIterator__i32
    var inline666 FnIterator__i32 = _goml_m_inherent_i_Vec_i_Vec_l_T_r__i_iter____T__i32(source__4)
    for_iter416 = inline666
    Loop_loop485:
    for {
        var for_next417 Option__i32
        var inline661 func() Option__i32 = for_iter416.next_fn
        var inline662 Option__i32 = inline661()
...
func _goml_m_sum____S__Slice_l_i32_r_(source__4 []int32) int32 {
    ...
    total__5 = inline683
    var for_iter416 FnIterator__i32
    var inline680 FnIterator__i32 = _goml_m_inherent_i_Slice_i_Slice_l_T_r__i_iter____T__i32(source__4)
    for_iter416 = inline680
    Loop_loop493:
    for {
        var for_next417 Option__i32
        var inline675 func() Option__i32 = for_iter416.next_fn
        var inline676 Option__i32 = inline675()
...
func _goml_m_inherent_i_Slice_i_Slice_l_T_r__i_iter____T__i32(self__414 []int32) FnIterator__i32 {
    var index__415 *ref_int_x = ref__Ref_3int(0)
    var len__416 int
    var inline699 int = len(self__414)
    len__416 = inline699
    var t521 closure_env_inherent_Slice_Slice_T_iter_T_i32_1 = closure_env_inherent_Slice_Slice_T_iter_T_i32_1{
        index_0: index__415,
        len_1: len__416,
        self_2: self__414,
    }
    var t522 func() Option__i32 = func() Option__i32 {
        return _goml_m_inherent_i_closure__en_h05f447217e0cf6cdcd746af967c79493__i32__1_i_apply(t521)
    }
    var inline697 FnIterator__i32 = FnIterator__i32{
        next_fn: t522,
    }
    return inline697
}

func _goml_m_inherent_i_closure__en_h1275f72f5de770912182f2a5cc7ddfae__i32__0_i_apply(env429 closure_env_inherent_Vec_Vec_T_iter_T_i32_0) Option__i32 {
    ...
    if t546 {
        ...
        var t548 Option__i32 = Option__i32{
            _tag: 1,
            _v1_0: value__318,
        }
        return t548
...
func _goml_m_inherent_i_closure__en_h05f447217e0cf6cdcd746af967c79493__i32__1_i_apply(env430 closure_env_inherent_Slice_Slice_T_iter_T_i32_1) Option__i32 {
    ...
    if t553 {
        ...
        var t555 Option__i32 = Option__i32{
            _tag: 1,
            _v1_0: value__418,
        }
        return t555
