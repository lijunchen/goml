...
func _goml_m_inherent_i_closure__env__run__0_i_closure__env__run__0_i_apply(env415 closure_env_run_0) Result__int32__string {
    ...
    if flag__3 {
        var inline495 Result__int32__string = Ok{
            _0: 7,
        }
        mtmp408 = inline495
    } else {
        var inline496 Result__int32__string = Err{
            _0: "nope",
        }
        mtmp408 = inline496
    }
    ...
    switch mtmp408.(type) {
    case Ok:
        var x409 int32 = mtmp408.(Ok)._0
        jp452 = x409
        var t453 int32
        var inline492 int32 = 1
        var inline493 int32 = jp452 + inline492
        t453 = inline493
        var t454 Result__int32__string = Ok{
            _0: t453,
        }
        return t454
    case Err:
        var x410 string = mtmp408.(Err)._0
        var t455 Result__int32__string = Err{
            _0: x410,
        }
        return t455
    default:
